...
from twitter_ads.enum import ENTITY, GRANULARITY, PLACEMENT, TRANSFORM, SEGMENTATION_TYPE
...
# 4 days
#         start_time = kwargs.get('start_time', end_time - timedelta(seconds=345600))
...
#         async_data
#         1 Month (31 days)
#         start_time = kwargs.get('start_time', end_time - timedelta(seconds=2678400))
#         2 Months (62 days)
#         start_time = kwargs.get('start_time', end_time - timedelta(seconds=5356800))
#         90 Days (3 Months)
#         start_time = kwargs.get('start_time', end_time - timedelta(seconds=7776000))
    
#     --------------------------------------------------------------------------------
#     Segmentation (45 days)
        start_time = kwargs.get('start_time', end_time - timedelta(seconds=3888000))


        
#         start_time = kwargs.get('start_time', end_time - timedelta(seconds=864000))
#         granularity = kwargs.get('granularity', GRANULARITY.HOUR)
        granularity = kwargs.get('granularity', GRANULARITY.DAY)
#         granularity = kwargs.get('granularity', GRANULARITY.TOTAL)
    ...
    @classmethod
    def queue_async_stats_job(klass, account, ids, metric_groups, segmentation, **kwargs):
...
#         params['segmentation_type'] = kwargs.get('segmentation_type', None)
        params['segmentation_type'] = kwargs.get('segmentation_type', segmentation)
